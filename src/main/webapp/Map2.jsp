...
<c:forEach var="m" items="${mapList}" >
	...
	var iwContent = '<div style="padding:1px;">${m.r_name}<br><a href="detail?Ma='+position.Ma+'&La='+position.La+'">상세보기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
